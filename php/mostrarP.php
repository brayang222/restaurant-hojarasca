        ...
        margin: 100px auto;">
            ...
            if (isset($_GET["btns"]) && $_GET["Buscar"] != null) {
                ...
                while ($vec = mysqli_fetch_array($cons)) { ?>
                    ...
                    <div class="modal fade" id="exampleModal-<?php echo $vec[0]; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content bg-secondary">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">¿Está seguro que desea eliminar esta
                                        empresa?</h1>
                            ...
                            <div class="modal-content bg-secondary">
                                <div class="modal-header">
                                    <div class="container" style="max-width: 500px;
                                        ...
                                        <h3 class="card-title"
                                            style="text-align: center;padding: 20px; font-family: serif; font-weight: bold;">
                                            Actualizar Pedido</h3>
                                        <form action="ActEmpresa.php" method="post">
                                            <div class="mb-3">
                                                <label class="form-label"> id pedido</label>
                                                <input type="number" class="form-control" aria-describedby="cedulaHelp"
                                                    name="idPedido" required value="<?php echo $vec[0] ?>">
                                            </div>
                                            <div class="mb-3">
                        ...
                        while ($v = mysqli_fetch_array($Consulta2)) {
                            echo "<option value = " . $v[0] . ">" . $v[1] . "-" . $v[2] .
                                "</option>";
                                    ...
                                    <button style="margin-left:10px" type="button" class="btn-close btn btn-danger"
