...
<?php  include "navbar.php" ?>
    ...
    box-shadow: 0px 0px 10px rgba(255, 255, 255, 1.2);">
        <h3 class="card-title" style="text-align: center;padding: 20px; font-family: serif; font-weight: bold;">Formulario Cliente</h3>
    <form action="regCliente.php" method="post">
        <div class="mb-3">
          <label class="form-label">Cédula cliente</label>
          <input type="number" class="form-control" aria-describedby="cedulaHelp" name="CedulaCliente" required>
        </div>
        <div class="mb-3">
